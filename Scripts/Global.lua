...
local factionData = {
    {
        ...
        playerBoard = gitLink("Factions/Castione_Ducal/Personal_Board.webp"),
        deckRow     = 1,
...
▶ Gain 3 Gold.
▶ Perform Alliance 1.]],
        actionMarkerPrincess   = gitLink("Factions/Castione_Ducal/Action_Chip_Princess.png"),
        actionMarkerKnight     = gitLink("Factions/Castione_Ducal/Action_Chip_Knight.png"),
        relationMarkerPrincess = gitLink("Factions/Castione_Ducal/Bond_Chip.png"),
        relationMarkerKnight   = gitLink("Factions/Castione_Ducal/Bond_Chip_Back.png"),
        scoreTile              = gitLink("Factions/Castione_Ducal/70VP_Tile.webp"),
        scoreTileBack          = gitLink("Factions/Castione_Ducal/70VP_Tile_Back.webp"),
        affectionTile          = gitLink("Factions/Castione_Ducal/Affection_Tile.webp"),
        affectionTileBack      = gitLink("Factions/Castione_Ducal/Affection_Tile_Back.webp"),
        factionToken           = gitLink("Factions/Castione_Ducal/Faction_Marker.png"),
        },
    {
        name        = "Visconti Ducal",
        colour      = {r=48, g=149, b=28},
        deckRow     = 2,
        playerBoard = gitLink("Factions/Visconti_Ducal/Personal_Board.webp"),
...
CONTINUOUS: You are treated as having an additional ☆ in the Grand Duke's Evaluation Track.]],
        ...
        actionMarkerPrincess   = gitLink("Factions/Visconti_Ducal/Action_Chip_Princess.png"),
        actionMarkerKnight     = gitLink("Factions/Visconti_Ducal/Action_Chip_Knight.png"),
        relationMarkerPrincess = gitLink("Factions/Visconti_Ducal/Bond_Chip.png"),
        relationMarkerKnight   = gitLink("Factions/Visconti_Ducal/Bond_Chip_Back.png"),
        scoreTile              = gitLink("Factions/Visconti_Ducal/70VP_Tile.webp"),
        scoreTileBack          = gitLink("Factions/Visconti_Ducal/70VP_Tile_Back.webp"),
        affectionTile          = gitLink("Factions/Visconti_Ducal/Affection_Tile.webp"),
        affectionTileBack      = gitLink("Factions/Visconti_Ducal/Affection_Tile_Back.webp"),
        factionToken           = gitLink("Factions/Visconti_Ducal/Faction_Marker.png"),
        },
    {
        name        = "Draug Earl",
        colour      = {r=220, g=220, b=33},
        deckRow     = 3,
        playerBoard = gitLink("Factions/Draug_Earl/Personal_Board.webp"),
        ...
        actionMarkerPrincess   = gitLink("Factions/Draug_Earl/Action_Chip_Princess.png"),
        actionMarkerKnight     = gitLink("Factions/Draug_Earl/Action_Chip_Knight.png"),
        relationMarkerPrincess = gitLink("Factions/Draug_Earl/Bond_Chip.png"),
        relationMarkerKnight   = gitLink("Factions/Draug_Earl/Bond_Chip_Back.png"),
        scoreTile              = gitLink("Factions/Draug_Earl/70VP_Tile.webp"),
        scoreTileBack          = gitLink("Factions/Draug_Earl/70VP_Tile_Back.webp"),
        affectionTile          = gitLink("Factions/Draug_Earl/Affection_Tile.webp"),
        affectionTileBack      = gitLink("Factions/Draug_Earl/Affection_Tile_Back.webp"),
        factionToken           = gitLink("Factions/Draug_Earl/Faction_Marker.png"),
        },
    {
        name        = "Berserk Marquis",
        colour      = {r=228, g=125, b=5},
        deckRow     = 4,
        playerBoard = gitLink("Factions/Berserk_Marquis/Personal_Board.webp"),
        ...
        actionMarkerPrincess   = gitLink("Factions/Berserk_Marquis/Action_Chip_Princess.png"),
        actionMarkerKnight     = gitLink("Factions/Berserk_Marquis/Action_Chip_Knight.png"),
        relationMarkerPrincess = gitLink("Factions/Berserk_Marquis/Bond_Chip.png"),
        relationMarkerKnight   = gitLink("Factions/Berserk_Marquis/Bond_Chip_Back.png"),
        scoreTile              = gitLink("Factions/Berserk_Marquis/70VP_Tile.webp"),
        scoreTileBack          = gitLink("Factions/Berserk_Marquis/70VP_Tile_Back.webp"),
        affectionTile          = gitLink("Factions/Berserk_Marquis/Affection_Tile.webp"),
        affectionTileBack      = gitLink("Factions/Berserk_Marquis/Affection_Tile_Back.webp"),
        factionToken           = gitLink("Factions/Berserk_Marquis/Faction_Marker.png"),
        },
    {
        name        = "Einherjar Viscount",
        colour      = {r=29, g=72, b=174},
        deckRow     = 5,
        playerBoard = gitLink("Factions/Einherjar_Viscount/Personal_Board.webp"),
...
CONTINUOUS: When performing the Supply action, you may treat this as an additional space with the effect "Increase the Grand Duke's Evaluation by 1."]],
        ...
        actionMarkerPrincess   = gitLink("Factions/Einherjar_Viscount/Action_Chip_Princess.png"),
        actionMarkerKnight     = gitLink("Factions/Einherjar_Viscount/Action_Chip_Knight.png"),
        relationMarkerPrincess = gitLink("Factions/Einherjar_Viscount/Bond_Chip.png"),
        relationMarkerKnight   = gitLink("Factions/Einherjar_Viscount/Bond_Chip_Back.png"),
        scoreTile              = gitLink("Factions/Einherjar_Viscount/70VP_Tile.webp"),
        scoreTileBack          = gitLink("Factions/Einherjar_Viscount/70VP_Tile_Back.webp"),
        affectionTile          = gitLink("Factions/Einherjar_Viscount/Affection_Tile.webp"),
        affectionTileBack      = gitLink("Factions/Einherjar_Viscount/Affection_Tile_Back.webp"),
        factionToken           = gitLink("Factions/Einherjar_Viscount/Faction_Marker.png"),
        },
    {
...
CONTINUOUS: Your play limit for Episode Cards increases by the number of ☆ you have in the Grand Duke's Evaluation. (Increases by up to 4.)]],
        ...
        },
    {
        ...
        deckRow     = 7,
        playerBoard = gitLink("Factions/Spartacus_Baronet/Personal_Board.webp"),
        ...
        actionMarkerPrincess   = gitLink("Factions/Spartacus_Baronet/Action_Chip_Princess.png"),
        actionMarkerKnight     = gitLink("Factions/Spartacus_Baronet/Action_Chip_Knight.png"),
        relationMarkerPrincess = gitLink("Factions/Spartacus_Baronet/Bond_Chip.png"),
        relationMarkerKnight   = gitLink("Factions/Spartacus_Baronet/Bond_Chip_Back.png"),
        scoreTile              = gitLink("Factions/Spartacus_Baronet/70VP_Tile.webp"),
        scoreTileBack          = gitLink("Factions/Spartacus_Baronet/70VP_Tile_Back.webp"),
        affectionTile          = gitLink("Factions/Spartacus_Baronet/Affection_Tile.webp"),
        affectionTileBack      = gitLink("Factions/Spartacus_Baronet/Affection_Tile_Back.webp"),
        factionToken           = gitLink("Factions/Spartacus_Baronet/Faction_Marker.png"),
        }
}
local playerData = {
    Red = {
